...
do
    ...
    python src/federated.py --data=cifar10 --local_ep=2 --bs=256 --num_agents=10 --rounds=200 --partition='homo' \
            ...
            --storing_dir='./cifar10_pattern_size_'$i --pattern_size=$i --pattern_type="size_test"

...
do
    ...
    python src/federated.py --data=fedemnist --load_pretrained=True --pretrained_path='../data/saved_models/femnist_pretrain/checkpoint_10.pt' --local_ep=2 --bs=256 --num_agents=10 --rounds=5 --partition='homo' \

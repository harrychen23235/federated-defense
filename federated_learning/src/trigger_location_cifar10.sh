...
do
    ...
    python src/federated.py --data=cifar10 --local_ep=2 --bs=256 --num_agents=10 --rounds=5 --partition='homo' \
            --num_corrupt=4  --client_lr=0.1 --attack_mode='normal' --poison_frac=0.1 --malicious_style=mixed  \
            --attack_start_round=0  --load_pretrained=True --pretrained_path='../data/saved_models/cifar_pretrain/model_last.pt.tar.epoch_200' \

...
do
    ...
    python src/federated.py --data=fedemnist --local_ep=2 --bs=256 --num_agents=10 --rounds=15 --partition='homo' \
        --num_corrupt=2  --client_lr=0.1 --poison_lr=0.05 --attack_mode='fixed_generator' --poison_frac=0.2 --malicious_style=mixed  \
        --attack_start_round=5 --storing_dir='./trigger_generation/femnist_pattern_size_trigger_generation_'$i --pattern_size=$i --pattern_type="size_test" \

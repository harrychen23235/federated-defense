...
do
    ...
    python src/federated.py --data=cifar10 --local_ep=2 --bs=256 --num_agents=20 --rounds=15 --partition='homo' \
            ...
            --storing_dir='./trigger_generation_seperate_vector_4_mali/cifar10_trigger_generation_pattern_size_'$i --pattern_size=$i --pattern_type="size_test" \
            --alpha=0.8 --save_checkpoint=True --seperate_vector=True --save_trigger=True
done
